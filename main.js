...
//                      toaster
//                          - toasting time goes down by half a second for 5 upgrades
//                      double score
//                          - player gets double score for 30 seconds. this is available forever but the price triples each time 
...
/** Class representing a bread object @extends PIXI.Sprite*/
class breadObj extends PIXI.Sprite {
    ...
    changeTexture(loader, setting){
        ...
        return new Promise((resolve) => {
            ...
            this.timerLoop = setTimeout(loop, 3000);
        });
    }
...
class toasterObj extends PIXI.Sprite{
    ...
    /**
     * Change the toaster setting property and texture of toaster dial
     *
     * @alias toasterObj.changeSetting
     * 
     * @param {PIXI.Sprite} dial    Dial object of toaster
     * @param {PIXI.Loader} loader  PIXIloader containing all the game asset
     * 
     * @returns null
     */
...
/** Class representing a knife @extends PIXI.Sprit3*/
class knifeObj extends PIXI.Sprite{
    /**
     * Create the knife object
     * 
     * @param {number} x                X position of knife
     * @param {number} y                Y Position of knife
     * @param {PIXI.Texture} texture    Texture of knife
     * @param {spreadObj} parent        Spread that was clicked on to create knife
     */
    ...
    /**
     * Start dragging the knife by setting a property to true
     * @alias knifeObj.dragStart
     * 
     * @param {object} e    Mouse Data
     * @returns null 
     */
    ...
    /**
     * Drag the knife if dragging property is trye
     * @alias knifeObj.dragMove
     * 
     * @param {object} e    Mouse Data
     * @returns null
     */
    ...
    /**
     * Stop dragging the knife and spread onto the toast if the knife collidies with it.
     * @alias knifeObj.dragEnd
     * 
     * @param {breadObj} bread      current bread object 
     * @param {PIXI.Loader} loader  loader containing game files
     * @param {PIXI.Sprite} plate   plate that finishes the order.
     * 
     * @returns null
     */
...
/** Class representing a spread @extends PIXI.Sprite*/
...
/** Class representing the in-game timer @extends PIXI.Sprite*/
class timerObj extends PIXI.Sprite{
    ...
    /** Get the textures for the timer @param {PIXI.Loader} Loader  game files loader */
    getTextures(loader){
        let array = [];
...
class orderData{
    /**
     * Make an order
     * @param {number} x                    X position of where sprites should appear
     * @param {number} y                    Y position of where sprites should appear
     * @param {number} toastState           A randomly generated number that dictates that toast state for order
     * @param {array} toastSpreads          Array containing all spreads in game
     */
    ...
    /**
     * Get textures for order and display them
     * 
     * @param {PIXI.Container} container    
     * @param {PIXI.Sprite} orderTV 
...
function mainGame(){
    ...
    shoppingCart.mousedown = () => console.log('shop');
